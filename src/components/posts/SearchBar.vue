...
const { changeParams } = postsStore

const changeSearchTerm = (e) => changeParams('q', e.target.value)
</script>
...
<template>
    <div class="mb-4 px-2 w-full">
        <div class="relative">
            ...
            <input @change="changeSearchTerm" class="w-full border pl-12 pr-4 py-2 rounded-full focus:border-blue-500 focus:shadow-outline outline-none" type="text" placeholder="Search..." />
        </div>
    </div>
</template>